...
SECRET_KEY = 'django-insecure--ob2#@)juv-ymq)0(=f8fpzs$3t(xwoql+9cpm5@%x$wm_z=!5'
...
INSTALLED_APPS = [
    ...
    'crispy_bootstrap4', # Add crispy_bootstrap4 for Bootstrap 4 styling
    'admin_panel',
]
...
STATICFILES_DIRS = [
    BASE_DIR / 'admin_panel' / 'templates' / 'admin_panel' / 'assets',
]
